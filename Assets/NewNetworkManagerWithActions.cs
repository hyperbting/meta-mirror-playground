...
public class NewNetworkManagerWithActions : NetworkManager
{
    ...
    public static new NewNetworkManagerWithActions singleton => (NewNetworkManagerWithActions)NetworkManager.singleton;
    ...
    {
        Debug.Log("NewNetworkManagerWithActions.OnStartAction invoked");
    }
